...
var require_versioning_strategy = __commonJS({
  "node_modules/.pnpm/release-please@16.12.0/node_modules/release-please/build/src/versioning-strategy.js"(exports2) {
    ...
    exports2.MajorVersionUpdate = MajorVersionUpdate2;
    var MinorVersionUpdate2 = class {
      /**
       * Returns the new bumped version
       *
       * @param {Version} version The current version
    ...
    exports2.MinorVersionUpdate = MinorVersionUpdate2;
    var PatchVersionUpdate2 = class {
      /**
       * Returns the new bumped version
       *
       * @param {Version} version The current version
    ...
    exports2.PatchVersionUpdate = PatchVersionUpdate2;
    var CustomVersionUpdate2 = class {
    ...
    exports2.CustomVersionUpdate = CustomVersionUpdate2;
  }
});
...
__export(default_exports, {
  DefaultVersioningStrategy: () => DefaultVersioningStrategy
});
module.exports = __toCommonJS(default_exports);
var import_versioning_strategy = __toESM(require_versioning_strategy(), 1);
...
var DefaultVersioningStrategy = class {
  ...
  constructor(options = {}) {
    ...
    this.logger = options.logger ?? import_logger.logger;
  }
  /**
  ...
  determineReleaseType(version, commits) {
    ...
    for (const commit of commits) {
      ...
      if (releaseAs) {
        ...
        return new import_versioning_strategy.CustomVersionUpdate(
          import_version.Version.parse(releaseAs.text).toString()
        );
      }
      if (commit.breaking) {
        breaking++;
    ...
    if (breaking > 0) {
      if (version.isPreMajor && this.bumpMinorPreMajor) {
        return new import_versioning_strategy.MinorVersionUpdate();
      }
      return new import_versioning_strategy.MajorVersionUpdate();
    }
    if (features > 0) {
      if (version.isPreMajor && this.bumpPatchForMinorPreMajor) {
        return new import_versioning_strategy.PatchVersionUpdate();
      }
      return new import_versioning_strategy.MinorVersionUpdate();
    }
    return new import_versioning_strategy.PatchVersionUpdate();
